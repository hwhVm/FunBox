 ...
 */
package com.example.administrator.baseapp.utils.permission;
...
import com.example.administrator.baseapp.utils.AfterPermissionGranted;
...
public class EasyPermissions {
    ...
    public static void requestPermissions(@NonNull Activity activity,
        ...
        BLog.d("   shouldShowRationale(activity, perms)="+shouldShowRationale(activity, perms));
