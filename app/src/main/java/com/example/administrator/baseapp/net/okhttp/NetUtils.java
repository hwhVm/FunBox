package com.example.administrator.baseapp.net.okhttp;
...
//		Log.d("com.beini", "----初始化okhttp请求----------->NetUtils");
	 ...
	 * 断点续传
	 */
	public void breakpointUploadFile() {
			...
			public void onResponse(Call call, Response response) throws IOException {//子线程
				...
				if (response.isSuccessful()) {
					...
					for (int i = 0; i < responseHeaders.size(); i++) {
						Log.d("com.beini", responseHeaders.name(i) + ": " + responseHeaders.value(i));
					}
